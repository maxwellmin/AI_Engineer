...
|---|------|-------------|--------|
| 1.1 | Add pymilvus dependency | Add pymilvus to pyproject.toml | Pending |
| 1.2 | Create constants | Define collection names, field names, index params | Pending |
| 1.3 | Create exceptions | Custom exception classes for Milvus operations | Pending |
| 1.4 | Create DTOs | Dataclasses for requests and responses | Pending |
| 1.5 | Implement MilvusClient | Singleton client with connection management | Pending |
| 1.6 | Update settings | Add Milvus configuration to settings | Pending |
| 1.7 | Update environment | Add MILVUS_* variables to .env file | Pending |
...
| # | Task | Description | Status |
|---|------|-------------|--------|
| 2.1 | Define collection schema | Create schema with multi-vector fields | Pending |
| 2.2 | Implement create_collection | Create collection with BM25 function | Pending |
| 2.3 | Implement has_collection | Check if collection exists | Pending |
| 2.4 | Implement list_collections | List all collections | Pending |
| 2.5 | Implement drop_collection | Delete collection | Pending |
| 2.6 | Implement describe_collection | Get collection details | Pending |
...
| # | Task | Description | Status |
|---|------|-------------|--------|
| 3.1 | Implement create_index | Create HNSW index for dense vectors | Pending |
| 3.2 | Implement create_sparse_index | Create sparse index for BM25 | Pending |
| 3.3 | Implement load_collection | Load collection into memory | Pending |
| 3.4 | Implement release_collection | Release collection from memory | Pending |
| 3.5 | Implement get_index_stats | Get index statistics | Pending |
...
| # | Task | Description | Status |
|---|------|-------------|--------|
| 4.1 | Implement insert_vectors | Batch insert vectors with metadata | Pending |
| 4.2 | Implement upsert_vectors | Insert or update vectors | Pending |
| 4.3 | Implement delete_vectors | Delete vectors by filter or IDs | Pending |
| 4.4 | Implement get_vector | Retrieve single vector by ID | Pending |
| 4.5 | Implement query_vectors | Query vectors with filter | Pending |
...
| # | Task | Description | Status |
|---|------|-------------|--------|
| 5.1 | Implement vector_search | Single vector field search | Pending |
| 5.2 | Implement hybrid_search | Multi-vector hybrid search with RRF | Pending |
| 5.3 | Implement bm25_search | BM25 sparse vector search | Pending |
| 5.4 | Implement search_with_filter | Search with metadata filter | Pending |
...
| # | Task | Description | Status |
|---|------|-------------|--------|
| 6.1 | Implement MilvusService | Facade service coordinating all operations | Pending |
| 6.2 | Create test fixtures | Setup test Milvus instance and sample data | Pending |
| 6.3 | Write client tests | Test MilvusClient connection and basic ops | Pending |
| 6.4 | Write collection tests | Test collection management | Pending |
| 6.5 | Write vector tests | Test vector CRUD operations | Pending |
| 6.6 | Write search tests | Test search functionality | Pending |
| 6.7 | Write integration tests | End-to-end tests with real Milvus | Pending |
...
- [ ] MilvusClient singleton with connection pooling
- [ ] Collection creation with multi-vector schema
- [ ] HNSW index creation for dense vectors
- [ ] Sparse index creation for BM25
- [ ] Batch vector insertion
- [ ] Vector search by single field
- [ ] Hybrid search with RRF ranking
- [ ] BM25 text search
- [ ] Vector deletion by ID and filter
...
| File | Purpose |
|------|---------|
| `apps/milvus_database_controller/constants.py` | Field/index names, defaults |
| `apps/milvus_database_controller/exceptions.py` | Custom exceptions |
| `apps/milvus_database_controller/dto.py` | Data transfer objects |
| `apps/milvus_database_controller/client/__init__.py` | Client module init |
| `apps/milvus_database_controller/client/milvus_client.py` | MilvusClient wrapper |
| `apps/milvus_database_controller/managers/__init__.py` | Managers module init |
| `apps/milvus_database_controller/managers/collection_manager.py` | Collection ops |
| `apps/milvus_database_controller/managers/index_manager.py` | Index ops |
| `apps/milvus_database_controller/managers/vector_manager.py` | Vector CRUD |
| `apps/milvus_database_controller/managers/search_manager.py` | Search ops |
| `apps/milvus_database_controller/services/__init__.py` | Services module init |
| `apps/milvus_database_controller/services/milvus_service.py` | Facade service |
| `apps/milvus_database_controller/schemas/__init__.py` | Schemas module init |
| `apps/milvus_database_controller/schemas/collection_schema.py` | Schema definitions |
| `apps/milvus_database_controller/tests/__init__.py` | Tests module init |
| `apps/milvus_database_controller/tests/conftest.py` | Test fixtures |
| `apps/milvus_database_controller/tests/test_*.py` | Test files |

### Modified Files

| File | Changes |
|------|---------|
| `pyproject.toml` | Add pymilvus dependency |
| `config/settings/base.py` | Update MILVUS_CONFIG |
| `env/.env.local` | Add MILVUS_URI, MILVUS_TOKEN |
